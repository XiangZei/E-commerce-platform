...
<head>
    ...
    <script type="text/javascript">
        ...
        function goOrderConfirm(){
            window.location.href="/电子商务平台/cart/orderConfirm";
        }
        //清空
        function godelete(){
            if(window.confirm("真的清空购物车嘛？")){
                window.location.href="/电子商务平台/cart/clear";
                return true;
            }
            return false;
        }
        ...
        function deleteAgoods(gno){
            if(window.confirm("真的删除改商评嘛？")){
                window.location.href="/电子商务平台/cart/deleteAgoods?id="+gno;
                return true;
            }
            return false;
        }
        ...
        <div>
            <div class="nFlowBox">
                ...
                cellspacing="1" bgcolor="#dddddd">
                    ...
                    <c:forEach var="ce" items="${carlist}">
                        <tr>
